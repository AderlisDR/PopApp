...
namespace PopAppAPI.Migrations
{
    ...
    [Migration("20201214004909_RefactoredScheduleEntities")]
    partial class RefactoredScheduleEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PopAppCore.Entities.Schedule", b =>
                {
                    b.HasOne("PopApp.Core.Entities.Vessel", "Vessel")
                        .WithMany()
                        .HasForeignKey("VesselId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PopAppCore.Entities.ScheduleContainer", b =>
                {
                    b.HasOne("PopApp.Core.Entities.Container", "Container")
                        .WithMany()
            ...
            modelBuilder.Entity("PopAppCore.Entities.ScheduleContainerFreigth", b =>
                {
                    b.HasOne("PopApp.Core.Entities.Freigth", "Freigth")
                        .WithMany()
